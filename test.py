...
def predict(model, image_fps, filepath='sample_submission.csv', min_conf=0.9, is_gt=False, visualize=False):
...
if __name__ == "__main__":
	...
	run(args.fp, int(args.groundtruth), int(args.visualize))
